# ProctorNet Staging Environment Root
# Provisions disposable staging environment:
# - Replicates 100% of production hybrid networking topology
# - Burstable EC2 sizing (var.instance_type = "t3.large" or "t3.xlarge")
# - Scale-ready modules (RDS, ElastiCache, ALB) disabled by default
